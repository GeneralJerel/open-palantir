      ...
      return (
        <IntelCard>
          ...
          <div style={{ padding: t.spacing.lg, borderBottom: `1px solid ${t.colors.borderSubtle}` }}>
            <div style={{ fontFamily: t.fonts.mono, fontSize: 10, color: t.colors.actionRequired, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 4 }}>
              Recommended Response
            </div>
            <div style={{ fontSize: 15, fontWeight: 700, marginBottom: t.spacing.sm }}>{args.proposedAction}</div>
            <SeverityBadge level={args.urgency as string} label={`URGENCY: ${args.urgency}`} />
          </div>

          {/* Rationale */}
          <div style={{ padding: `${t.spacing.md}px ${t.spacing.lg}px`, fontSize: 12, color: t.colors.textDim, borderBottom: `1px solid ${t.colors.borderSubtle}` }}>
            {args.rationale}
          </div>
                ...
                {impacts.map((item: any, i: number) => (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: i < impacts.length - 1 ? `1px solid ${t.colors.borderSubtle}` : 'none',
                    }}
                  >
                    <span
                      style={{
          ...
          {isExecuting ? (
            <div style={{ display: 'flex', gap: t.spacing.sm, padding: t.spacing.lg, borderTop: `1px solid ${t.colors.border}` }}>
              <button
